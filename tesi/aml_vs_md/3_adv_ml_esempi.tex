...
\end{center}
\ \\
Hanno allenato la \textit{GAN} contro le seguenti tipologie di classificatori (tutti allenati con le impostazioni di default proposte dalla libreria \say{scikit-learn} di Python: \(80\%\) del dataset come \textit{training set}):
